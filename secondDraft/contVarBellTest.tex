...
We expect \cite{Atul} that the class of $d$-dimensional entangled states which demonstrate nonlocality here will be different from those considered by Collins \emph{et al.}\cite{Collins}.
