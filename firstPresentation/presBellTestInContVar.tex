...
\includegraphics[width=2cm]{images/otfried}\includegraphics[width=2cm]{images/asadian}
\end{itemize}
\end{frame}
...
forces; t
\item \includegraphics[width=5cm]{images/carToAtom}\cite{car}\cite{atom}
\item Heisenberg, Schrödinger et. al. : `Quantum Mechanics' $[\hat{\mathbf{q}},\hat{\mathbf{p}}]=i\hbar$
\end{itemize}
\end{frame}
