...
\end{equation}
expressed in terms of suitable local CV observables $\hat A$ which take a limited range of values to impose a well-defined classical bound. %be able to determine a well-defined classical bound. 
