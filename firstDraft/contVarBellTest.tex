...
\] 
The smallest $N$ s.t. $\ab{\mean{ \mathcal {\hat B} }} >2$, is $N\ge7$; see figure \ref{chshViolation}.
...
It is essential to know what ballpark resolution is required for detecting the violation from the screen. If our measurement can faithfully resolve the following, from our previous discussions it implies that a violation will be obtained.
\[
