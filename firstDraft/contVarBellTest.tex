...
everything after the grating, then the setup is expected to produce a $\left|\psi_{+}\right\rangle $ state, just after the grating. To produce the desired entangled state, we start with two entangled photons, such that their polarization state can be expressed as $\ket{\chi} \equiv \frac{ \ket{\rightarrow}_1\ket{\uparrow}_2 -\ket{\uparrow}_1\ket{\rightarrow}_2 }{\sqrt{2}}$. Their spatial description (along $x$-axis) is initially assumed to be $\ket{\zeta} = \ket{\gamma}_1 \ket{\gamma}_2$.
...
\[
\frac{ \ket{\rightarrow}_1\ket{\uparrow}_2 -\ket{\uparrow}_1\ket{\rightarrow}_2 }{\sqrt{2}} \ket{\psi_+}_1\ket{\psi_+}_2
\]
...
\[
\frac{\ket{\rightarrow}_1\ket{\uparrow}_2\ket{\psi_+}_1\ket{\psi_-}_2 - \ket{\uparrow}_1\ket{\rightarrow}_2\ket{\psi_-}_1\ket{\psi_+}_2}{\sqrt 2} 
\]
...
\]
where $\left|\nearrow\right\rangle \equiv\left(\left|\rightarrow\right\rangle +\left|\uparrow\right\rangle \right)/\sqrt{2}$.
...
\]
%\[\left|\left\langle q{}_{A},q{}_{B}|\Psi{}_{f\,\text{screen}}\right\rangle \right|^{2}\propto\left|\left\langle p{}_{A}=\frac{p_{z}q{}_{A}}{D},p{}_{B}=\frac{p_{z}q{}_{B}}{D}|\Psi_{f}\right\rangle \right|^{2}\]
...
from which $\braket{ \hat{X}\otimes\hat{X} }$ can be computed as discussed. $f$ is changed to evaluate all the 4 terms to finally obtain $\left\langle C\right\rangle $ experimentally.
\\
...
If we define $\left|\nearrow\right\rangle \equiv\frac{\left|\rightarrow\right\rangle +\left|\uparrow\right\rangle }{\sqrt{2}},$
$\left|\nwarrow\right\rangle \equiv-\frac{\left|\rightarrow\right\rangle -\left|\uparrow\right\rangle }{\sqrt{2}}$
and the $45^{\circ}$ projector as $\left|\nearrow\right\rangle \left\langle \nearrow\right|$,
then both $\left|\rightarrow\right\rangle \to\left|\nearrow\right\rangle $ and $\left|\uparrow\right\rangle \to\left|\nearrow\right\rangle$
