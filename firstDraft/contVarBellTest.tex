...
It is essential to know what ballpark resolution is required for detecting the violation from the screen. The histogram discussed in sec [], will be given by $\left| \braket{p_1,p_2|\Psi_f} \right| ^2$. If our measurement can faithfully resolve this, it follows from our previous discussions that a violation will be obtained. This expression may be explicitly evaluated from %$\braket{p_1, p_2 | \Psi_f}&=\frac{1}{\sqrt 2} \tilde{\varphi}(p_1) \tilde{\varphi}(p_2)$
\[
