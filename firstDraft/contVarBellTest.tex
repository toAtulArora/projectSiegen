...
The measurement setting is applied by local unitaries like $\hat U(\theta)\otimes \hat U(\phi)$. A local unitary can be performed by placing alternating glass slabs of widths such that equation \ref{eqn:U} holds. These slabs may be placed right after the birefringent crystals, before the polarizer. 
