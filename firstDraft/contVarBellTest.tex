...
\documentclass[10pt,landscape,british,pra,twocolumn,superscriptaddress,nofootinbib,nobibnotes,tightenlines]{revtex4}
...
Particular class of bounded observable can be constructed from the quantum mechanical phase space translation operator

This observable is not Hermitian therefore it does not directly correspond to an observable. 
