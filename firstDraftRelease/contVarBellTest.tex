...
\end{equation*}
\begin{figure}
\includegraphics[bb=0bp 70bp 359bp 170bp,clip,width=9cm]{zeroOne-eps-converted-to.pdf}\\
%(a) $\left\langle q|\psi_{0}\right\rangle $ (dashed) and $\left\langle q|\psi_{1}\right\rangle $\bigskip{}
%\\
\vspace{2mm}
\includegraphics[bb=0bp 70bp 359bp 140bp,clip,width=9cm]{plus-eps-converted-to.pdf}\\
%(b) $\left\langle q|\psi_{+}\right\rangle $\bigskip{}
%\\
\vspace{2mm}
\includegraphics[bb=0bp 20bp 359bp 140bp,clip,width=9cm]{minus-eps-converted-to.pdf}\\
